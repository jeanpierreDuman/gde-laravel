            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12" style="margin-bottom: 65px; margin-top: 15px;">
                        <h3 style="color: white; float">Information du dossier</h3>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <form id="form-check" action="{{ route('folder_integrer_post', $folder->id) }}" method="post" enctype="multipart/form-data">
                @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12" style="margin-bottom: 65px; margin-top: 15px;">
                                <h3 style="color: white; float: left;">Les documents enregistrés</h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
                    ...
                    <tbody>
                        @foreach ($folder->files as $file)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('show_upload', ['id' => $file->id]) }}" target="_blank" class="btn btn-sm btn-default">
                                        <span>Voir</span>
                                    </a>
                                </td>
                            </tr>
            ...
            @else
                <p class="mt-4 pb-3" style="color: white;">
...
<form style="display:none;" id="validation-integrer" action="{{ route('folder_validation_integrer', ['id' => $folder->id]) }}" method="post">
    @csrf
</form>
...
$(document).ready(function() {
    ...
    $("#form-verification-button-submit").click(function(e) {
        ...
        $.post({
            url: "{{ route('folder_integrer_post', $folder->id) }}",
            data: getValues(),
